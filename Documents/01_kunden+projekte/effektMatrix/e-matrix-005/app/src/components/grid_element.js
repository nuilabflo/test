  ...
  componentDidMount(){
    ...
    getCurve(){
      ...
      ctx.clearRect(0, 0, c.width, c.height);
        ...
        envCurve = envArray(this.props.envelop.slice(0,5))[0];
         let border = 100;//this.state.envelop[1].left;//envArray(this.state.envelop.slice(0,5))[1]
    ...
    playSound(mc,t){
      ...
      let myArrayBuffer = this.audioCtx.createBuffer(2, this.audioCtx.sampleRate*t, this.audioCtx.sampleRate);
    ...
    render(){
      ...
      // if(this.props.envelop){
        ...
        envelopCanvas = <div className='envelopelement'>
        <canvas className='eCanvas' ref='myECanvas' width={100} height={101} />

        </div>
      // }else{
        // envelopCanvas = <div className='envelopelement'>
        // <canvas className='eCanvas' ref='myECanvas' width={100} height={101} onClick={this.click}/>
        // </div>
      // }
      ...
      return(
          <div className='curveCanvas' ref='curveCanvas' onClick={this.click}>
              <canvas className='canvas' ref='myCanvas' width={100} height={101} />
              {envelopCanvas}
          </div>
      )
    }
